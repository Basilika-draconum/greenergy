    ...
    <section className="section-main" id="faq">
      <div className="container-main tablet:grid tablet:grid-cols-2  tablet:grid-rows-2 tablet:gap-6 desktop:gap-[185px]">
        <Title
          ...
          className={
            "mb-6 tablet:col-start-2 tablet:col-end-3 tablet:row-start-1 tablet:row-end-2 tablet:mb-0 desktop:text-2xl"
          }
        />
        <div className="mb-9 max-w-[345px] mx-auto tablet:mx-0 tablet:col-start-1 tablet:col-end-3 tablet:row-start-1 tablet:row-end-3 tablet:mb-0 desktop:max-w-[516px]">
          {frequentlyQuestions.map(({ id, question, answer }, index) => (
            ...
            >
              <summary className="text-question desktop:text-2xl desktop:tracking-[-0.96px] before:content-linkAdd before:absolute before:top-[18px] before:left-[-31px] before:w-[16px] before:h-[16px] desktop:before:top-[17px]">
                {question}
              </summary>
              <p className="mt-4 text-subQuestion desktop:text-description">
                {answer}
              </p>
            </details>
          ))}
